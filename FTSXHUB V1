...
Toggle.Position = UDim2.new(0.120833330, 0, 0.0952890819, 0)
...
--------------------------------------------------------------------
Main:AddSeperator("YT:Tu Free Script - FTSXHUB - Freescript")
...
fast:AddSeperator("Attack Settings")

fast:AddToggle("Fast Attack",true,function(Fast)
...
fast:AddToggle("Fast Attack 1",false,function(Fastz)

_G.FastAttack1 = Fastz
...
fast:AddToggle("Fast Attack 2",false,function(Fastx)

_G.FastAttack2 = Fastx
...
CombatFramework.activeController.attacking = false
CombatFramework.activeController.timeToNextAttack = 0
CombatFramework.activeController.increment = 5
CombatFramework.activeController.hitboxMagnitude = 100
CombatFramework.activeController.blocking = false
CombatFramework.activeController.timeToNextBlock = 0
CombatFramework.activeController.focusStart = 0
...
fast:AddToggle("Fast Attack 3",false,function(Fastc)

_G.FastAttack3 = Fastc
...
CameraShakerR:Stop()
CombatFramework.activeController.attacking = false
CombatFramework.activeController.timeToNextAttack = 100
...
fast:AddToggle("Fast Attack 4",false,function(Fastd)

_G.FastAttack4 = Fastd
...
local AutoFarm = Main:AddToggle("Auto Farm Level 1",_G.AutoFarm,function(value)
_G.AutoFarm = value
...
if World1 then
auto:AddToggle("Auto Second Sea",_G.AutoSecondSea,function(value)
...
if World2 then
auto:AddToggle("Auto Third Sea",_G.AutoThirdSea,function(value)
...
if World2 then
auto:AddToggle("Auto Farm Factory",_G.AutoFactory,function(value)
...
elseif World3 then
auto:AddToggle("Auto Mystic Island",_G.AutoMysticIsland,function(value)
...
Main:AddToggle("Auto Mastery fruit",_G.AutoFarmFruitMastery,function(value)
...
_G.Kill_At = 25
Main:AddSlider("Kill heatlh %",1,100,25,function(value)
_G.Kill_At = value
end)
...
_G.PointStats = 1
Stats:AddSlider("Select Point",1,1000,1,function(value)
_G.PointStats = value
end)
...
Shop:AddButton("Buy GodHuman",function()
...
Misc:AddToggle("Walk on Water[ no fix ]",_G.WalkWater,function(value)
_G.WalkWater = value
end)
